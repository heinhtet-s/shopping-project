...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    $page=end($link_array);
    ?>
    <?php if($page=="category.php" || $page=="user_index.php" || $page=="index.php"){ ?>
    <form class="form-inline ml-3" method="get" action="<?php if ($page=='index.php'){echo'index.php';}elseif($page=='user_index.php'){echo'user_index.php';}else{echo'category.php';}?>">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="royal_m.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Royal Member</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Shopping Page</h1>
          </div><!-- /.col -->

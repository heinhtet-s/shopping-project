      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
           ...
           $stmt=$pdo->prepare("SELECT * FROM posts WHERE name LIKE '%$searchkey%' ");
             $stmt->execute();
             $rawuser=$stmt->fetchAll();
             
             
             $total_pages=ceil(count($rawuser)/$numOfrecs);
             $stmt= $pdo->prepare("SELECT * FROM  posts WHERE name LIKE '%$searchkey%' ORDER BY id DESC LIMIT $offset,$numOfrecs ");
             $stmt->execute();
             $user=$stmt->fetchAll();

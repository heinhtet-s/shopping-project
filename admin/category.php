      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
           ...
           $stmt=$pdo->prepare("SELECT * FROM categories WHERE name LIKE '%$searchkey%' ");
             $stmt->execute();
             $rawuser=$stmt->fetchAll();
             ...
             ?>
              <!-- /.card-header -->
              <div class="card-body">
                <a href="cat_add.php" class="btn btn-success">Create Category</a> 
                <div><br></div>
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <td><?php echo substr( escape($u['description']),0,50) ?></td>
                      ...
                      <a href="cat_edit.php?id=<?php echo$u['id']; ?>" class="btn btn-warning">edit</a>
                  
                    
                      <a href="cat_delete.php?id=<?php echo $u['id']; ?>"  onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-warning">delete</a>

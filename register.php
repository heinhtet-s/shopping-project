...
if(empty($_POST['password']) || strlen($_POST['password'])<4 || empty($_POST['email']) || empty($_POST['username']) || empty($_POST['address']) || empty($_POST['phone'])){
if(empty($_POST['password'])){
	$password_error="Password field cannot be null";
}elseif(strlen($_POST['password'])<4){
	$password_error="Password should be 4 char at least";
}
...
if(empty($_POST['username'])){
    ...
    if(empty($_POST['address'])){
        ...
        if(empty($_POST['phone'])){
            $phone_error="Phone number cannot be null";
    ...
    $stat=$pdo->prepare("SELECT * FROM users WHERE email=:email");
     ...
     if(!empty($user)){
         ...
         echo"<script>document.location.href = 'register.php',true;</script>";}else{
	...
	<header class="header_area sticky-header">
		<div class="main_menu">
			...
			<div class="container">
					...
					<a class="navbar-brand logo_h" href="index.html">Orchid Shopping</a>
					...
					<div class="login_form_inner">
						...
						<input type="hidden" name="_token" value="<?php echo $_SESSION['_token']?>">
                            ...
                            <p class="text-danger"><?php echo empty($phone_error)? '':  $phone_error; ?></p>
								<input type="text" class="form-control" id="name" name="phone" placeholder="Phone number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone number'">
                            </div>
							<div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
                                <button type="submit" value="submit" class="primary-btn">Register</button><br>
